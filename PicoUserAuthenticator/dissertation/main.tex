...
Total word count: 14903 (starting from page 1 excluding appendix sections and bibliography) \footnote{Word count of main text, headers, footnotes, floats, and captions was computed using the command: {\tt texcount -inc Chapters/*.tex}. The word count for tables was computed manually to a total of 273.}.
...
\input{Appendices/Appendix-android}
\input{Appendices/Appendix-frameworkex}
\input{Appendices/Appendix-mechanisms}
