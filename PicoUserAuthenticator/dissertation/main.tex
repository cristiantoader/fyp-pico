...
{\huge \bfseries User Authentication for Pico}\\[0.4cm] % Thesis title
\HRule \\[1.5cm] % Horizontal line
 
\begin{minipage}{0.4\textwidth}
\begin{flushleft} \large
\emph{Author:}\\
{Cristian M. Toader} % Author name - remove the \href bracket to remove the link
\end{flushleft}
\end{minipage}
\begin{minipage}{0.4\textwidth}
...
\textit{in the}\\[0.4cm]
Computer Security Group \\ Computing Department \\[2cm] % Research group name and department name
